...
export default function SearchPageClient() {
  ...
  const renderPaginationButtons = () => {
    ...
    const endPageCalc = Math.min(totalPages - 1, startPage + maxVisiblePages - 1);

    if (endPageCalc - startPage + 1 < maxVisiblePages) {
      startPage = Math.max(0, endPageCalc - maxVisiblePages + 1);
    }
    ...
    if (endPageCalc < totalPages - 1) {
      if (endPageCalc < totalPages - 2) {
